...
uses
  ...
  ExtCtrls, ComCtrls, ShlObj, Menus, ExtDlgs, Buttons, ToolWin, jpeg,
...
function EditHyperImages(HI: TCustomHyperImages; SaveToComponent: Boolean; NewDirectory : String): Boolean;
...
begin
  ...
  {$endif}
  {$ifdef HI_D5}
    //if (HSEditForm.ImageList = nil) then
     // HSEditForm := THSEditForm.CreateEditor(self,HSEditForm.FHyperImages);
...
//  not DrawingFigure;
  ...
  SaveToFile.Enabled := (FHyperImages.HotspotsDef.Count > 0);
...
begin
  if (FHyperImages <> nil) then begin
