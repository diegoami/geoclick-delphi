...
uses
  ...
  dsgnintf,
  dcconsts, dcsystem, dcapi, dcgen, dccommon, dclib
  ;
...
procedure TPropNameEditor.GetPropEdit(Prop: TPropertyEditor);
begin
  fProc(Prop.GetName);
  Prop.Free;
end;
...
begin
  if Component <> nil then
    begin
      ...
      try
        GetComponentProperties(clist, GetFilter, Designer, GetPropEdit);
      finally
        clist.Free;
      end;
    end;
