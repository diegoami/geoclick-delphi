...
uses
  ...
  graphics,StdCtrls,treemod,forms,dcconsts, stdactns,dbactns,db,controls,dclib,comctrls;
        ...
        try
          ...
          if FilterStringsForm(Sl, SVerbStandardAction,0,[]) then
            ...
            begin
              ...
              Cname := C.Classname;
              if (Cname<>'') and ((Cname[1] = 'T') or (Cname[1] = 't')) then
                System.Delete(Cname,1,1);
