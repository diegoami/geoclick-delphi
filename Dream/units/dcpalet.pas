...
uses
  ...
  commctrl,menus,dcsystem,dclib,dcapi,dcconsts, dccommon, dcgen,
...
begin
  ...
  if (length(bClassName) > 0) and (bClassName[1] = 'T') then
...
begin
  FreeSortedList(TPagesList(FNewPages));
