...
uses
  ...
  StdCtrls, Grids,
  dsgnintf,
  dcsystem,dcconsts,consts,dcedit,dccommon,dclib;
...
begin
  SetFormFont(self);
  Caption := SFilterEdit;
  ButtonOk.Caption := ResStr(SOKButton);
  ButtonCancel.Caption := ResStr(SCancelButton);
  ButtonHelp.Caption := ResStr(SHelpButton);
end;
