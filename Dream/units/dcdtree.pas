...
uses
  ...
  dclib, ComCtrls, CommCtrl, dcconsts{$IFDEF D4},imglist{$ENDIF};
...
type
  ...
  public
    ...
    property NodeState : TDrawNodeStates read GetNodeState write SetNodeState;
  published
...
begin
  ...
  Filer.DefineBinaryProperty('DrawData', ReadStreamData, WriteStreamData, true);//don't resource
end;
